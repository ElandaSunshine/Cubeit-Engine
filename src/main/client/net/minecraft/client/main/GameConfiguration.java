...
public class GameConfiguration
{
    ...
    public static class FolderInformation
    {
        ...
        public final File   gameRootDir;
        public final File   resourcePacksDir;
        public final File   assetsDir;
        public final String assetIndex;

        public FolderInformation(File mcDataDirIn, File gameRootDirIn, File resourcePacksDirIn, File assetsDirIn,
        						 @Nullable String assetIndexIn)
        {
            this.mcDataDir        = mcDataDirIn;
            this.gameRootDir      = gameRootDirIn;
