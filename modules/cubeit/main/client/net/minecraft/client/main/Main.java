...
import xyz.elandasunshine.cvm.exception.GameNotFoundException;
...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<File>    optionspec2  = optionparser.accepts("dataDir")          .withRequiredArg().ofType(File.class)   .defaultsTo(new File("."));
        ...
        OptionSpec<File>    optionspec20 = optionparser.accepts("gameDir")          .withRequiredArg().ofType(File.class);
        ...
        File file4 = (File) optionset.valueOf(optionspec20);
