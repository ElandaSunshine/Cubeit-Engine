...
public class PotionType
{
    ...
    public static void registerCubeitPotionTypes(Registry<PotionType> registry)
    {
        ...
        {
        	registerPotionType(GameManager.getInstance().gameInfo.gameId + ":" + type.getKey(), type.getValue());
        }
    ...
    public boolean hasInstantEffect()
    {
        ...
        {
            UnmodifiableIterator<PotionEffect> unmodifiableiterator = this.effects.iterator();
