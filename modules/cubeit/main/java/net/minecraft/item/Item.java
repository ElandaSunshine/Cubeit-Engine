...
public class Item
{
    ...
    {
        return net.minecraft.util.text.translation.I18n.translateToLocal(this.getUnlocalizedName(stack));
    }
	...
	public String getItemStackDisplayName(ItemStack stack)
    {
        return net.minecraft.util.text.translation.I18n
        						 .translateToLocal(this.getUnlocalizedNameInefficiently(stack) + ".name").trim();
    }
    ...
    public static void registerCubeitItems(ObjectRegistry registry)
    {
        ...
        for (int i = 0; i < items.size(); ++i)
        {
        	...
        	registerItem(ObjectRegistry.cubeitItemStartId + i,
