...
public abstract class Enchantment
{
    ...
    {
        String s = net.minecraft.util.text.translation.I18n.translateToLocal(this.getName());
        ...
        return (level == 1 && this.getMaxLevel() == 1
        	       ? s
        		   : s + " " + net.minecraft.util.text.translation.I18n.translateToLocal("enchantment.level." + level));
    }
    ...
    {        
        for (int i = 0; i < registry.size(); ++i)
        {
        	...
        	final ResourceLocation loc = new ResourceLocation(id, entry.getKey());
        	
        	REGISTRY.register(ObjectRegistry.cubeitEnchantmentStartId + i, loc, entry.getValue());
        }
    }
