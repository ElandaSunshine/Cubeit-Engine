...
public class EntityList
{
    ...
    {
        return (Class<? extends Entity >)field_191308_b.getObjectById(entityID);
    }
    ...
    {
        return (Class<? extends Entity >)field_191308_b.getObject(new ResourceLocation(p_192839_0_));
    }
    ...
    {        
        for (int i = 0; i < registry.size(); ++i)
        {
        	...
        	func_191303_a(ObjectRegistry.cubeitEntityStartId + i, id + ":" + entry.getKey(),
        	...
        	if (def.entityEggColor != null)
        	{
        		...
        		func_191305_a(id + ":"  + entry.getKey(), egg.primaryEggColor, egg.secondaryEggColor);
        	}
        }
    }
