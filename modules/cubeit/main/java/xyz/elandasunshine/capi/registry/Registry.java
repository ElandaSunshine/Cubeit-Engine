...
public final class Registry<T> implements Iterable<RegistryEntry<T>>
{
	...
	private class RegistryIterator implements Iterator<RegistryEntry<T>>
	{
		...
		//==============================================================================================================
		@Override public boolean          hasNext() { return index < registry.size(); }
		@Override public RegistryEntry<T> next()    { return registry.getEntryAt(index++); }
	}
	
	//==================================================================================================================
	private ArrayList<RegistryEntry<T>> elements = Lists.newArrayList();
	private Class<T> type;
	
	//==================================================================================================================
	public Registry(Class<T> parType) { this.type = parType; }
	...
	//==================================================================================================================
	@Override public Iterator<RegistryEntry<T>> iterator() { return new RegistryIterator(this); }
	
	//==================================================================================================================
	public Class<T> getRegistryType() { return type; }
}
